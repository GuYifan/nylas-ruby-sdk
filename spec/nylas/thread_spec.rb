  ...
  it "can be deserialized from JSON" do
    ...
    json = JSON.dump(id: "thread-2345", account_id: "acc-1234", draft_ids: ["dra-987"],
                     ...
                     messages: [{ account_id: "acc-1234", bcc: [], cc: [], date: 1_510_080_788, files: [],
                                  from: [{ email: "andy-noreply@google.com", name: "Andy" }], id: "message-123",
                                  labels: [], object: "message", reply_to: [], snippet: "One", starred: false,
                                  subject: "Thread Test", thread_id: "thread-2345",
                                  to: [{ email: "hellocohere@gmail.com", name: "John Smith" }], unread:false}],
